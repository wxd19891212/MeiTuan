...
@interface JGMoreViewController () <UITableViewDataSource,UITableViewDelegate>
{
...
@implementation JGMoreViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    JGMoreViewCell *cell = [JGMoreViewCell cellWithTableView:tableView];
